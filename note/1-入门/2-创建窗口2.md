...
***注意，这里特别重要，如果在使用OpenGL函数之前，不确保GLAD的初始化结果，那么就会出现各种访问错误问题。比如 `glClear(GL_COLOR_BUFFER_BIT);`，就会出现空指针拒绝访问问题（OpenGL 的 glClear() 导致 Windows 64 中的访问冲突 (0xc0000005)）。***
...
![img](https://learnopengl-cn.github.io/img/01/03/hellowindow.png)
...
![img](https://learnopengl-cn.github.io/img/01/03/hellowindow2.png)
