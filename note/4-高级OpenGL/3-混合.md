...
| `GL_ONE_MINUS_SRC_ALPHA`      | 因子等于$1-\vec{C}_{source}$的alpha分量      |
| `GL_DST_ALPHA`                | 因子等于$\vec{C}_{destination}$的alpha分量   |
| `GL_ONE_MINUS_DST_ALPHA`      | 因子等于$1-\vec{C}_{destination}$的alpha分量 |
...
| `GL_ONE_MINUS_CONSTANT_ALPHA` | 因子等于$1-\vec{C}_{constant}$的alpha分量    |
