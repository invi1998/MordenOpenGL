...
void Model::LoadModel()
{
	...
	const aiScene* scene = importer.ReadFile(m_Filepath.c_str(), aiProcess_Triangulate | aiProcess_GenSmoothNormals | aiProcess_FlipUVs | aiProcess_CalcTangentSpace | aiProcess_EmbedTextures);
